...
class AuthViewModel extends ChangeNotifier {
  ...
  Future<bool> registerUser({String? username, String? password, String? repassword}) async {
    var res = await Api.instance.register(username: username, password: password, repassword: repassword);
    if (res.errorCode == 0) {
      return true;
    } else {
      return false;
